...
async function execute(ctx) {
    ...
    if (helpArg === 'kuis') {
        ...
        helpMsg = wrapInBox('🖼️ GAMBAR', 'Cari gambar dari Pinterest ke chat.\n\nCommand:\n• .gambar [keyword]\n\nLimit: 3 gambar/hari\nBonus: +5 XP/gambar\n\nInfo: Beli limit di .toko (item 3).');
    } else if (helpArg === 'xp') {
        ...
        helpMsg = wrapInBox('⚔️ KOMBO', 'Rekomendasi 3 Pokemon terbaik di tas kamu.\n\nCommand:\n• .kombo / .combo\n\nAturan:\n• Sesuai grade aktif\n• Banned diabaikan\n• Ambil LV tertinggi');
        ...
        helpMsg = wrapInBox('🎖️ LEVEL', 'Gelar otomatis:\n• Lvl 10: Ksatria\n• Lvl 50: Legenda\n• Lvl 100: Dewa\n\nCustom Title:\nBeli di .toko untuk gelar bebas.');
