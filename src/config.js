...
const CONFIG = {
    ...
    CLOUDFLARE_API_KEY: ENV_CONFIG.CLOUDFLARE.API_KEY,
    CLOUDFLARE_ACCOUNT_ID: ENV_CONFIG.CLOUDFLARE.ACCOUNT_ID,
    CLOUDFLARE_MODEL: ENV_CONFIG.CLOUDFLARE.MODEL,
    CEREBRAS_API_KEY: ENV_CONFIG.CEREBRAS.API_KEY,
    CEREBRAS_MODEL: ENV_CONFIG.CEREBRAS.MODEL,
    NVIDIA_API_KEY: ENV_CONFIG.NVIDIA.API_KEY,
    NVIDIA_MODEL: ENV_CONFIG.NVIDIA.MODEL,
    DISCORD_WEBHOOK_URL: ENV_CONFIG.DISCORD.WEBHOOK_URL,
};
